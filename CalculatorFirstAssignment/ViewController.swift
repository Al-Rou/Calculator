 /*
  ...
  Description: iOS Calculator
               ...
               In this very new version of our application, seven new functionalities were added including Tan, Sin, Cos, Squareroot, Square, Rand, and Pi number. These new functionalities appear whenever the screen is rotated, so that it stays on horizontal orientation.
